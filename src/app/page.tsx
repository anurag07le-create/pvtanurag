...
const events: NetflixItem[] = [
  {
    id: 'event-mehendi',
    type: 'event',
    title: 'Episode 01: Mehendi Night',
    ...
    time: '6:00 PM',
    venue: 'The Grand Resort',
    address: 'Gujarat, India',
    synopsis: 'The wedding week opens with color, music, and a relaxed evening for close family and friends.',
    cast: 'Bride Side, Groom Side, Family & Friends',
    genres: 'Musical, Tradition, Celebration',
    mood: 'Colorful, Joyful, Festive',
    tags: ['Mehendi', 'Music', 'Family'],
  },
  {
    id: 'event-haldi',
    type: 'event',
    title: 'Episode 02: Haldi Morning',
    img: '/images/photo1.jpeg',
    eyebrow: 'Dec 5',
    year: '2026',
    rating: 'U/A 13+',
    ...
    address: 'Gujarat, India',
    synopsis: 'A sunlit celebration of blessings, laughter, turmeric, and family rituals before the big day.',
  ...
  },
  {
    id: 'event-sangeet',
    type: 'event',
    title: 'Episode 03: Sangeet Premiere',
    img: '/images/photo2.jpeg',
    eyebrow: 'Dec 5',
    year: '2026',
    rating: 'U/A 13+',
    ...
    venue: 'The Grand Resort',
    address: 'Gujarat, India',
    synopsis: 'Performances, family face-offs, friends on stage, and the night where the wedding turns into a concert.',
    cast: 'Friends, Cousins, Family Performers',
    genres: 'Musical, Dance, Comedy',
    mood: 'Electric, Loud, Unforgettable',
    tags: ['Sangeet', 'Dance', 'Party'],
  },
  {
    id: 'event-wedding',
    type: 'event',
...
const utilities: NetflixItem[] = [
  ...
  },
  {
    ...
    duration: '2 min',
    quality: 'HD',
    synopsis: 'A practical venue card with route links, parking notes, nearby stay information, and one-tap navigation.',
    cast: 'All Guests',
    genres: 'Travel, Venue',
...
export default function Home() {
  ...
  return (
    <div className="relative min-h-screen bg-netflix-black pb-12">
      ...
      <main className="relative z-20 -mt-10 pb-10">
        <Row
          title={`Top Picks For ${profile.label}`}
          subtitle="Personalized wedding premiere cards."
          items={profile.id === 'friends' ? [events[2], utilities[0], story[3], utilities[2]] : [events[3], utilities[0], story[2], utilities[1]]}
